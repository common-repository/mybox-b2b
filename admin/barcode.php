 ...
 *  Company: Rocketwood.LLC www.rocketwood.com
 *  Date:	05/25/2003
 *  Usage: <img src="/barcode.php?text=testing" alt="testing" />
 *	Guide: http://davidscotttufts.com/2009/03/31/how-to-create-barcodes-in-php   https://github.com/davidscotttufts/php-barcode
 */
	
	// Get pararameters that are passed in through $_GET or set to the default value
	$text = (isset($_GET["text"])?$_GET["text"]:"0");
	$size = (isset($_GET["size"])?sanitize_text_field($_GET["size"]):"20");
