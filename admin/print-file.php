...
<html>
   <head>
      ...
      <link href="<?php echo plugin_dir_url(__FILE__); ?>css/pdf-style.css" rel="stylesheet">
	</head>
	<body>
			      ...
			      <div class="page overflow-hidden">
			         <div class="row mx-0">
			            <div class="col-12 d-flex justify-content-between pb-3 px-0">
			               <img src="<?php echo plugin_dir_url(__FILE__); ?>img/logo-mybox-exp.png" alt="image" class="logo" />
			                  ...
			                  <section class="q-r-code w-100">
			                     <div class="d-flex">
			                        ...
			                        <div class="flex-shrink-0 d-flex align-items-center justify-content-center" style="height: 100px; width: 100px;background: lightgray">
			                        	<img src="<?php echo plugin_dir_url(__FILE__);?>img/logo-1.svg" style="width: 55px">
			                        </div>
			                     </div>
			                  </section>
			               </div>
